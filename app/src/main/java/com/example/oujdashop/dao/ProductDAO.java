        ...
        try (SQLiteDatabase db = dbHelper.getReadableDatabase()) {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    Product product = new Product(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getFloat(3),cursor.getString(4),categoryDAO.getCategory(cursor.getInt(5)));
